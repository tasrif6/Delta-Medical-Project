                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2 self-end md:self-auto">
                        ...
                        <Button
                          ...
                          className="border-blue-800 hover:bg-blue-600 text-white cursor-pointer"
                        >
                          View Details
                        </Button>
                      </div>
      ...
      {selectedDoctor && (
        <Dialog open={!!selectedDoctor} onOpenChange={handleCloseDialog}>
          <DialogContent className="max-w-3xl">
            <DialogHeader>
              <DialogTitle className="text-xl font-bold gradient-title">
                Doctor Verification Details
              </DialogTitle>
              <DialogDescription>
                Review the doctors information carefully before making a
                decision
              </DialogDescription>
            </DialogHeader>
            ...
            {loading && <BarLoader width={"100%"} color="#1520A6" />}
